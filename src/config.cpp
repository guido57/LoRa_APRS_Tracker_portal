...
namespace Config_ns{
    ...
    std::vector<Entry>  Entries = {
        ...
        {"beacon_timeout", "1", "Int", "beacon timeout i.e messages period in minutes e.g. 1"},
        ...
        {"smart_beacon_turn_min", "25", "Int","smart beacon i.e send at 'fast_rate' when turn > turn_min in degrees e.g. 25"},
        {"smart_beacon_slow_rate", "300", "Int","smart beacon slow rate i.e. send every 'slow_rate' seconds e.g. 300"},
        {"smart_beacon_slow_speed", "10", "Int","smart beacon slow speed i.e. send at 'slow_rate' when speed < slow_speed e.g. 10"},
        {"smart_beacon_fast_rate", "60", "Int","smart beacon slow rate i.e. send at 'fast_rate' secondse.g. 60"},
        {"smart_beacon_fast_speed", "100", "Int","smart beacon fast speed i.e. send at 'fast_rate' when speed > fast_speed e.g. 100"},
        {"smart_beacon_min_bcn","15", "Int","smart beacon minimum beacon ??? e.g. 5"},
        {"smart_beacon_min_tx_dist","15", "Int","smart beacon minimum tx distance ??? e.g. 100"},
        // fixed_beacon
        {"fixed_beacon_active", String(true), "Bool", "fixed beacon i.e. send at fixed rate and fixed coordinates e.g. false"},
        {"fixed_beacon_slow_rate", "300", "Int","fixed beacon i.e. send every 'slow_rate' seconds e.g. 300"},
        {"fixed_beacon_min_bcn","5", "Int","fixed beacon i.e. minimum beacon ??? e.g. 5"},
